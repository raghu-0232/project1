...
export default function EmployeeViewComponent() {
    return( 
            <Paper className="awaiting-approvals-container">
                <EmployeeViewHeaderComponent employeeData={employeeData.response}/>
                <EmployeeViewBodyComponent employeeData={employeeData.response}/>
            </Paper>
        )
}