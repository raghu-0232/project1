        ...
        return( 
                    ...
                    <Box display="flex"  className="active-shifts-buttons-container">
                        ...
                        <div className="shifts-view-buttons-sec-2">
                            <Button className="shift-generate-invoice-button" variant="contained" color="primary" onClick={this.handleClickOpen}>
                                Generate Invoice
                            </Button>
                            <Button className="shift-record-payment-button" variant="contained" color="primary"  onClick={this.handleClickOpen}>
                                Record Payment
                            </Button>
                        </div>
                    </Box>
