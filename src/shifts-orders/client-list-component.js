...
export default class ClientListComponent extends React.Component {
    ...
    render(){
        console.log("from clients", this.props.clientsData);
    return( 
            <Paper>
              <div className="client-list-filter-section">
              <FormControl className="select-dropdown-conatainer">
               ...
               { this.props.clientsData.length && this.props.clientsData.map( (client )=> ( <EachClientComponent data={client} />) ) }
